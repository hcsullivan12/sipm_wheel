...
#define R__DICTIONARY_FILENAME SiPMWheel_CoreIO
...
#line 1 "SiPMWheel_CoreIO dictionary forward declarations' payload"
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("SiPMWheel_CoreIO",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_SiPMWheel_CoreIO_Impl, {}, classesHeaders);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_SiPMWheel_CoreIO_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_SiPMWheel_CoreIO() {
  TriggerDictionaryInitialization_SiPMWheel_CoreIO_Impl();
}
