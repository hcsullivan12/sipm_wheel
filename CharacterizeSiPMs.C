...
std::string data_dir = "/home/hunter/projects/wheel/data/07_19_18/sipm4";
const unsigned nFiles = 4;

//std::string files[nFiles] = {"M1Channel01-Amplitude-74.0VB-4mVT00000.csv", "M1Channel01-Amplitude-74.3VB-4mVT00000.csv", "M2Channel01-Amplitude-73.5VB-3.3mVT00000.csv", "M2Channel01-Amplitude-73.7VB-3.3mVT00000.csv"};
//std::string files[nFiles] = {"M1Channel02-Amplitude-74.0VB-4mVT00000.csv", "M1Channel02-Amplitude-74.3VB-4mVT00000.csv", "M2Channel02-Amplitude-73.5VB-3.3mVT00000.csv", "M2Channel02-Amplitude-73.7VB-3.3mVT00000.csv"};
//std::string files[nFiles] = {"M1Channel03-Amplitude-74.0VB-4mVT00000.csv", "M1Channel03-Amplitude-74.3VB-4mVT00000.csv", "M2Channel03-Amplitude-73.5VB-3.3mVT00000.csv", "M2Channel03-Amplitude-73.7VB-3.3mVT00000.csv"};
std::string files[nFiles] = {"M1Channel04-Amplitude-74.0VB-4mVT00000.csv", "M1Channel04-Amplitude-74.3VB-4mVT00000.csv", "M2Channel04-Amplitude-73.5VB-3.3mVT00000.csv", "M2Channel04-Amplitude-73.7VB-3.3mVT00000.csv"};


/*std::string files[nFiles] = {"M1Channel01-Amplitude-updatedGates00000.csv", "M1Channel02-Amplitude-updatedGates00000.csv",
	                     "M1Channel03-Amplitude-updatedGates00000.csv", "M1Channel04-Amplitude-updatedGates00000.csv"};*/
...
///Fitting parameters
double ampThreshold  = 0.02; //0.05
double areaThreshold = 0.01;
double ampSig        = 2.0; //0.01  //now 0.05
double areaSig       = 0.1*TMath::Power(10, -9);
double ampFitRange   = 0.001;    //now 0.00020
...
void MakeHistograms(TH1D*, std::pair< std::vector<double>, std::vector<double> >, double );
...
void CharacterizeSiPMs()
{
  ...
  std::vector<double> biases = {74.0, 74.3, 73.5, 73.7};
  ...
  for(int file = 0; file < nFiles; file++) {
    ...
    MakeHistograms(ampDist, ampData, biases[file]);
...
void MakeHistograms(TH1D *dist, std::pair< std::vector<double>, std::vector<double> > dataSet, double type)
{
  ...
  std::string s = "SiPM Response in Dark Box " + std::to_string(type) + " V";
  dist->SetTitle(s.c_str());
  //if (type == "amplitude") {
